    ...
    return(
        <section id="about" className="my-5 p-4 scroll-margin">
            <section id="wrapper" className="skewed" onMouseMove={handleMouseMove}>
                ...
                <div className="layer top-section" style={{ width: sliderData.xPos + sliderData.skew + sliderData.delta + "px" }}>
                    <div className="content-wrap">
                        <div className="content-body mx-lg-4 p-4">
                ...
                <div className="handle-one" style={{ left: sliderData.xPos + sliderData.delta + "px" }}></div>
                <div className="handle-two" style={{ left: sliderData.xPos + sliderData.delta - 10 + "px" }}></div>
            </section>
